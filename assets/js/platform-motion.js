(function () {
  ...
  var LAYER_SLIDES = [
    ...
    { intro: false, badge: 'Layer 1 of 5', tagline: 'Clean. Validate. Prepare.', heading: 'Transform', desc: 'Remove duplicates, detect personally identifiable information, validate field integrity, and score data quality — programmatically, before any labeling begins.', href: '/platform/transform', linkText: 'Explore Transform →', node: 0 },
    { intro: false, badge: 'Layer 2 of 5', tagline: 'Annotate. Verify. Certify.', heading: 'Label', desc: 'A multi-engine orchestration layer routes each data point to the appropriate AI model. Items below the confidence threshold go to human reviewers. 25 annotation types across four data modalities.', href: '/platform/label', linkText: 'Explore Label →', node: 1 },
    { intro: false, badge: 'Layer 3 of 5', tagline: 'Snapshot. Trace. Export.', heading: 'Version', desc: 'Every processed dataset is frozen into an immutable, hash-verified snapshot, with a full lineage report and training-ready export.', href: '/platform/version', linkText: 'Explore Version →', node: 2 },
    { intro: false, badge: 'Layer 4 of 5', tagline: 'Monitor. Detect. Correct.', heading: 'Observe', desc: 'Prediction logs from deployed models flow back into the platform. Three drift checks identify when and where performance is degrading, and route a correction dataset back through labeling.', href: '/platform/observe', linkText: 'Explore Observe →', node: 3 },
    { intro: false, badge: 'Layer 5 of 5', tagline: 'Control. Audit. Comply.', heading: 'Govern', desc: 'Role-based permissions, an immutable audit log, and regulatory tags that travel with the data wherever it moves.', href: '/platform/govern', linkText: 'Explore Govern →', node: 4 }
  ];
